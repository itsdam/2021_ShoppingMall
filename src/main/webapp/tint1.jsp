	...
	<div style="display:flex">
        ...
        %>
        	<div style = "text-align: right; margin-right: 400px;">		
				...
				<button><a onclick="return confirm('해당 상품을 결제하시겠습니까?')" href="buyWriteAction.jsp?cosmeticID=<%=cosmeticID%>&cosmeticName=<%=cosmetic.getCosmeticName()%>&memberID=<%=memberID%>&buyPrice=<%=cosmetic.getCosmeticPrice()%>&cosmeticImage=<%=cosmetic.getCosmeticImage()%>">구매</a></button>
