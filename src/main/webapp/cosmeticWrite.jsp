		...
		<div class="row">
			<form method="post" action="cosmeticWriteAction.jsp">
				<table class="table table-striped" style="text-align: center; border: 1px solid #dddddd">
					<thead>
						<tr>
							<th colspan="2" style="background-color: #eeeeee; text-align: center;">상품 추가</th>
						</tr>
					</thead>
					<tbody>
					<tr>
					 ...
					 <tr>
					    ...
					    <td><textarea name="cosmeticContent" placeholder='상품 부연 설명을 적어주세요.' cols="30" rows="5"></textarea></td>
					 </tr>
					 <tr>
					</tbody>
				</table>
				<!-- 글쓰기 버튼 생성 -->
				<input type="submit" class="button pull-right" value="등록">
			</form>
		</div>
	</div>
		<hr>
