...
<body style="font-family: 'Nanum Myeongjo', serif">
	...
	<nav class="navbar navbar-light">
		<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            ...
            %>
				...
				<button class="info6"><a href="memberOrder.jsp">주문조회</a></button>
	            </div> </div>
	        <%
            	} 
	        %>
	...
	<div style="text-align:center;"><h3><strong>전체 주문 내역</strong></h3></div><br>
	<div class="container">
		<div class="row">
			<table class="table table-striped" style="text-align: right; border: 1px solid #dddddd">
				...
				<tbody style="background-color : white;">
					...
					<%
               			if(list.get(i).getOrderID() == list1.get(j).getOrderID()) {
                  
            		%>
					
					<tr>
						<td style="text-align: center;"><%= list.get(i).getOrderID()%></td>
