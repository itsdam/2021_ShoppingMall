			...
			<div class="jumbotron" style="padding-top: 20px" >
				<form method="post" action="managerLoginAction.jsp">
					...
					<div class="form-group">
						<input type="text" class="form-control" placeholder="아이디" name="managerID" maxlength="20">
					</div>
					<div class="form-group">
						<input type="password" class="form-control" placeholder="비밀번호" name="managerPassword" maxlength="20">
					</div>
